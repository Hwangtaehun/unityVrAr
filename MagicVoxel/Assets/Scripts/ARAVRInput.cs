...
public static class ARAVRInput
{
    ...
    public static void PlayVibaration(float duration, float frequency, float amplitude, Controller hand)
    {
#if Oculus
    ...
    {
#if Oculus
        PlayVibaration(0.06f, 1.0f, 1.0f, hand);
#elif Vive
        PlayVibaration(0.06f, 160.0f, 0.5f, hand);
#endif
    }
